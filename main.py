...
def createImages():
    ...
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\AND_geschlossen.jpg")  
     
    board, printSize, rasterCount, s1 = createNotGateBoard()
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\NOT_geoeffnet.jpg")  
     
    board, printSize, rasterCount, (s1) = createNotGateBoard()
    s1.setClosed(True)
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\NOT_geschlossen.jpg")  
     
    board, printSize, rasterCount, (s1, s2) = createOrGateBoard()
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\OR_geoeffnet.jpg")  
     
    board, printSize, rasterCount, (s1, s2) = createOrGateBoard()
    s1.setClosed(True)
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\OR_geschlossen.jpg")  
    ...
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\XOR_unten.jpg")  
    
    board, printSize, rasterCount, (s1, s2) = createXorGateBoard()
    s2.setPosition(1)
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\XOR_wechsel.jpg")  
    
    board, printSize, rasterCount, s1 = createSwitch12Board()
    s1.setPosition(1)
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\Wechselschalter_oben.jpg")  
    
    board, printSize, rasterCount, s1 = createSwitch12Board()
    s1.setPosition(0)
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\Wechselschalter_unten.jpg")  

    board, printSize, rasterCount, (s1, s2) = createCarryBitBoard()
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\2Bit_Addierer_geoeffnet.jpg")     
    
    board, printSize, rasterCount, (s1, s2) = createCarryBitBoard()
    s1.setClosed(True)
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\2Bit_Addierer_wechsel.jpg")     
    ...
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\2Bit_Addierer_geschlossen.jpg") 
    
    board, printSize, rasterCount, (s1, s2, s3) = createResultBoard()
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\result_geoeffnet.jpg") 
    ...
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\result_geschlossen.jpg") 
    ...
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\carry_geoeffnet.jpg") 
    
    board, printSize, rasterCount, (s1, s2, s3) = createCarryBoard()
    s1.setClosed(True)
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\carry_geschlossen1.jpg") 
    ...
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\carry_geschlossen2.jpg") 
    
    board, printSize, rasterCount, (s1, s2, s3) = create3BitAddingBoard()
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\3Bit_Addierer_geoeffnet.jpg") 
    ...
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\3Bit_Addierer_geschlossen.jpg") 
    ...
    printContext = createPrintContext(printSize, rasterCount)
    draw(printContext, board)
    printContext.save(r"C:\Users\nikst\ws\3Bit_Addierer_wechsel.jpg") 
